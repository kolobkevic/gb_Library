package gb.library.backend.official.exceptions;

import gb.library.backend.common.exceptions.AppError;
import gb.library.backend.common.exceptions.ErrorResponseDTO;
